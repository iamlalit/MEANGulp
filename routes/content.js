...
function ContentHandler (db) {
    ...
    this.displayMainPage = function(req, res, next) {
        ...
        posts.getPosts(10, function(err, results) {
            "use strict";
            //to get the header menu dynamically for blog page
            var headerMenu  = {};
            if(req.username){
                headerMenu = { '/': 'Home', '/newpost': 'Create a New Post', '/logout': 'Logout' };
            }else{
                headerMenu = { '/newpost': 'Create a Post', '/signup': 'Not a member? signup', '/login': 'Login' };
            }
    ...
    this.displayMainPageByTag = function(req, res, next) {
        ...
        posts.getPostsByTag(tag, 10, function(err, results) {
            ...
            if(req.username){
                ...
                headerMenu = { '/signup': 'Not a member? signup', '/login': 'Login' };
            }
    ...
    this.displayNewPostPage = function(req, res, next) {
        ...
        //to show the header when the user is login
        var headerMenu  = {};
        if(req.username){
            headerMenu = { '/': 'Home', '/newpost': 'Create a New Post', '/logout': 'Logout' };
        }
